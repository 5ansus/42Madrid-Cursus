...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/02/09 21:09:31 by sanferna          #+#    #+#             */
/*   Updated: 2026/02/09 21:09:32 by sanferna         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::attack(const std::string& target) {
	if (_hitPoints == 0) {
		std::cout << _getClassOverrided() << " " << _name
	...
	_energyPoints--;
	std::cout << _getClassOverrided() << " " << _name << " attacks " << target
...
void ClapTrap::takeDamage(unsigned int amount) {
	if (_hitPoints == 0) {
		std::cout << _getClassOverrided() << " " << _name << " is already destroyed!"
				<< std::endl;
		return;
	}
	if (amount >= _hitPoints) {
		_hitPoints = 0;
		std::cout << _getClassOverrided() << " " << _name << " takes " << amount
...
std::string ClapTrap::_getClassOverrided() { return "ClapTrap"; }
