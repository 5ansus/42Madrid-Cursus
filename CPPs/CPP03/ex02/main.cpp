...
int main() {
	...
	std::cout << "\nFragTrap:\n" << std::endl;
	std::cout << "Constructor" << std::endl;
	FragTrap frag1("Fraggy-001");

	std::cout << "\nAttacks" << std::endl;
	frag1.attack("Enemy 08");
	frag1.attack("Enemy 09");
	...
	std::cout << "\nClapTrap, ScavTrap and FragTrap" << std::endl;
	ClapTrap clap6("Clappy-006");
	ScavTrap scav3("Scavvy-003");
	FragTrap frag2("Fraggy-002");
	clap6.attack("Enemy 10");
	scav3.attack("Enemy 11");
	frag2.attack("Enemy 12");
